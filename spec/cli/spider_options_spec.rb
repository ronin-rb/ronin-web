...
describe Ronin::Web::CLI::SpiderOptions do
  class TestSpiderOptionsCommand < Ronin::Web::CLI::Command
    include Ronin::Web::CLI::SpiderOptions
  end

  let(:command_class) { TestSpiderOptionsCommand }
